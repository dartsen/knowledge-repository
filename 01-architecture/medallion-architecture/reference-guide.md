---
title: "Medallion Architecture Reference Guide"
domain: "Architecture"
...
# Medallion Architecture Reference Guide
...
This guide is designed to help you build from beginner understanding to professional and architect-level confidence. The focus is practical: how to explain Medallion Architecture, how to apply it in real enterprise work, how to govern it, how to troubleshoot issues, and how to improve it over time.

Medallion Architecture is used when teams need a structured way to make decisions, reduce confusion, align stakeholders, improve reliability, and connect technical work to business value.

## 01. Plain-English Explanation

Medallion Architecture is a layered data design pattern that organizes data into progressively refined layers, commonly raw, conformed, and curated.

**Analogy:** Think of it as refining raw materials. Bronze captures what arrived, silver cleans and standardizes it, and gold packages it for specific business use.

A beginner should focus on the simple idea: Medallion Architecture helps people understand how important parts fit together.

A professional should go further: Medallion Architecture helps teams make tradeoffs, document decisions, reduce risk, design for change, and build solutions that can be supported after go-live.

## 02. Business Context

Medallion Architecture matters because business work rarely happens inside one isolated tool. Most real business outcomes depend on people, systems, data, processes, controls, and operational support working together.
...
Medallion Architecture should be understood in relationship to the broader enterprise architecture.
...
Depending on the scenario, Medallion Architecture may touch:
...
A typical Medallion Architecture flow can be represented as:
...
Governance for Medallion Architecture should clarify how decisions are made, who owns what, how risk is managed, and how production solutions remain supportable.
...
|---|---|---|---|---|
| Databricks | Lakehouse, data engineering, analytics, and AI platform. | Supports Medallion Architecture documentation, design, delivery, or governance. | Learn what problem it solves before learning every feature. | Define ownership, standards, access, and storage location. |
| Delta Lake | Reliable lakehouse storage layer. | Supports Medallion Architecture documentation, design, delivery, or governance. | Learn what problem it solves before learning every feature. | Define ownership, standards, access, and storage location. |
| dbt | SQL transformation, testing, documentation, and lineage. | Supports Medallion Architecture documentation, design, delivery, or governance. | Learn what problem it solves before learning every feature. | Define ownership, standards, access, and storage location. |
| Unity Catalog | Data governance and access control in Databricks. | Supports Medallion Architecture documentation, design, delivery, or governance. | Learn what problem it solves before learning every feature. | Define ownership, standards, access, and storage location. |
| Power BI | BI reporting and semantic modeling. | Supports Medallion Architecture documentation, design, delivery, or governance. | Learn what problem it solves before learning every feature. | Define ownership, standards, access, and storage location. |
| SQL Warehouses | SQL compute for analytics and queries. | Supports Medallion Architecture documentation, design, delivery, or governance. | Learn what problem it solves before learning every feature. | Define ownership, standards, access, and storage location. |
| Databricks Workflows | Job orchestration. | Supports Medallion Architecture documentation, design, delivery, or governance. | Learn what problem it solves before learning every feature. | Define ownership, standards, access, and storage location. |
| Azure Data Lake Storage | Cloud data lake storage. | Supports Medallion Architecture documentation, design, delivery, or governance. | Learn what problem it solves before learning every feature. | Define ownership, standards, access, and storage location. |
...
This helps the organization improve data trust, reusable transformations, clear ownership, better lineage by making dependencies, decisions, risks, and ownership visible.

### Technical Explanation

Medallion Architecture connects requirements, systems, data, integrations, security, governance, delivery, and operations into a structured design or decision framework.
...
> Medallion Architecture helps translate business needs into a structured, governable, and supportable approach. It gives teams a shared view of current state, target state, risks, dependencies, owners, and the roadmap needed to deliver safely.
...
|---|---|---|---|---|---|---|
| Beginner | Basic purpose and vocabulary of Medallion Architecture. | What it is and why it matters. | A simple one-page explanation or diagram. | Memorizing terms without understanding value. | Explain Medallion Architecture to a non-technical person. | You can explain it in plain English. |
| Advanced Beginner | Common workflows, inputs, outputs, and stakeholders. | How Medallion Architecture supports a business process. | A current-state diagram or quick reference. | Jumping into tools too early. | Map one real workflow and its systems. | You can identify owners and dependencies. |
| Intermediate Practitioner | Tradeoffs, risks, design choices, and governance. | How to apply Medallion Architecture to a project. | A design note, checklist, or decision record. | Creating documentation without decisions. | Compare two solution options. | You can recommend an approach with rationale. |
...
| Enterprise Professional | Cross-team ownership, standards, roadmaps, and governance. | How Medallion Architecture supports enterprise outcomes. | A roadmap, standard, or operating model. | Ignoring organizational constraints. | Create a domain roadmap. | You can influence multiple teams. |
...
```text
01-architecture/medallion-architecture/reference-guide.md
```
