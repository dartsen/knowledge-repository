---
title: "Migration Patterns Reference Guide"
...
**Analogy:** Think of migration like moving a business to a new office. You do not just move furniture; you decide what to keep, what to redesign, what to retire, and how to avoid disrupting daily operations.

At a beginner level, focus on what Migration Patterns is and how it helps people use data.

At a professional level, focus on how Migration Patterns fits into the full analytics lifecycle: data source, model, calculation, report, security, deployment, adoption, monitoring, and continuous improvement.
...
Migration Patterns fits within the broader analytics architecture from data source to business consumption.
...
A typical Migration Patterns flow can be represented as:
...
|---|---|---|---|---|
| Power BI Service | Supports analytics and BI work related to Migration Patterns. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Power BI Desktop | Supports analytics and BI work related to Migration Patterns. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Deployment Pipelines | Supports analytics and BI work related to Migration Patterns. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Power BI REST APIs | Supports analytics and BI work related to Migration Patterns. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Databricks | Supports analytics and BI work related to Migration Patterns. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| dbt | Supports analytics and BI work related to Migration Patterns. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| SQL | Supports analytics and BI work related to Migration Patterns. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Usage Metrics | Supports analytics and BI work related to Migration Patterns. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Azure DevOps | Supports analytics and BI work related to Migration Patterns. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Excel Inventory | Supports analytics and BI work related to Migration Patterns. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
...
It helps improve reduced migration risk, modernized reporting, improved governance, technical debt reduction by turning trusted data into useful, governed, and actionable insights.

### Technical Explanation

Migration Patterns sits between governed data sources and business users, usually through semantic models, reports, dashboards, apps, access controls, refresh schedules, and deployment processes.
...
> Migration Patterns helps make analytics usable and trustworthy by connecting business questions to governed data, reusable models, clear visuals, controlled access, and a sustainable lifecycle.
...
|---|---|---|---|---|---|---|
| Beginner | Basic purpose and vocabulary of Migration Patterns. | What it is and why it matters. | A one-page summary. | Focusing only on visuals. | Explain it to a business user. | You can explain it simply. |
...
```text
03-analytics-bi/migration-patterns/reference-guide.md
```
