---
title: "Data Lineage Reference Guide"
...
This guide is designed to help you progress from beginner awareness to professional data engineering confidence. The goal is not only to understand Data Lineage, but to apply it in real enterprise environments where data must be reliable, governed, documented, monitored, and useful for analytics, automation, AI, and business decision-making.

## 01. Plain-English Explanation

Data Lineage shows where data comes from, how it changes, and where it is consumed downstream.

**Analogy:** Think of lineage as a package tracking number for data. It tells you where the data started, which stops it passed through, and who received it.

At a beginner level, focus on what Data Lineage is and what problem it solves.

At a professional level, focus on how Data Lineage connects to architecture, data quality, governance, testing, operational reliability, and business value.
...
Data Lineage fits into the larger enterprise data architecture as part of the path from source systems to trusted consumption.
...
A typical Data Lineage flow can be represented as:
...
|---|---|---|---|---|
| Lineage-Driven Impact Analysis | A common data engineering method, operating model, or design pattern. | Use when it fits the business, data, and platform context. | Improves consistency and quality. | Avoid applying it mechanically without context. |
| Metadata Management | A common data engineering method, operating model, or design pattern. | Use when it fits the business, data, and platform context. | Improves consistency and quality. | Avoid applying it mechanically without context. |
| Data Cataloging | A common data engineering method, operating model, or design pattern. | Use when it fits the business, data, and platform context. | Improves consistency and quality. | Avoid applying it mechanically without context. |
| Column-Level Lineage | A common data engineering method, operating model, or design pattern. | Use when it fits the business, data, and platform context. | Improves consistency and quality. | Avoid applying it mechanically without context. |
| Dependency Mapping | A common data engineering method, operating model, or design pattern. | Use when it fits the business, data, and platform context. | Improves consistency and quality. | Avoid applying it mechanically without context. |
| Change Impact Review | A common data engineering method, operating model, or design pattern. | Use when it fits the business, data, and platform context. | Improves consistency and quality. | Avoid applying it mechanically without context. |

## 14. Tools and Technologies

| Tool / Technology | What It Does | Where It Fits | Beginner Note | Enterprise Consideration |
|---|---|---|---|---|
| dbt Docs | Supports work related to Data Lineage. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| dbt Explorer | Supports work related to Data Lineage. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| Unity Catalog Lineage | Supports work related to Data Lineage. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| Microsoft Purview | Supports work related to Data Lineage. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| Data Catalogs | Supports work related to Data Lineage. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| SQL Dependency Queries | Supports work related to Data Lineage. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| Git | Supports work related to Data Lineage. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| Manifest Files | Supports work related to Data Lineage. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
...
It helps improve impact analysis, data trust, auditability, faster troubleshooting by making data more reliable, reusable, governed, and easier to consume.

### Technical Explanation

Data Lineage supports the path from source systems through ingestion, transformation, validation, governance, and consumption.
...
> Data Lineage helps us move from scattered, unreliable data work to a more governed and reusable data foundation. It supports reporting, automation, and AI by making data easier to trust, trace, secure, and operate.

## 17. Example Scenario

### Business Problem

A data team plans to change the source logic for policy status and needs to know which Power BI reports, automations, and curated models may be affected.
...
|---|---|---|---|---|---|---|
| Beginner | Basic purpose and vocabulary of Data Lineage. | What it is and why it matters. | A one-page summary. | Memorizing terms without context. | Explain it to a non-technical person. | You can explain it simply. |
...
```text
02-data-engineering/data-lineage/reference-guide.md
```
