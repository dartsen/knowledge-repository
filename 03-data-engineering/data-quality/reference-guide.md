---
title: "Data Quality Reference Guide"
...
This guide is designed to help you progress from beginner awareness to professional data engineering confidence. The goal is not only to understand Data Quality, but to apply it in real enterprise environments where data must be reliable, governed, documented, monitored, and useful for analytics, automation, AI, and business decision-making.

## 01. Plain-English Explanation

Data Quality is the discipline of checking whether data is accurate, complete, consistent, valid, timely, unique, and fit for its intended use.

**Analogy:** Think of data quality like inspecting materials before they enter production. Bad materials can still move through the factory, but they create defective products downstream.

At a beginner level, focus on what Data Quality is and what problem it solves.

At a professional level, focus on how Data Quality connects to architecture, data quality, governance, testing, operational reliability, and business value.
...
Data Quality fits into the larger enterprise data architecture as part of the path from source systems to trusted consumption.
...
A typical Data Quality flow can be represented as:
...
|---|---|---|---|---|
| Data Quality Dimensions | A common data engineering method, operating model, or design pattern. | Use when it fits the business, data, and platform context. | Improves consistency and quality. | Avoid applying it mechanically without context. |
| Quality Gates | A common data engineering method, operating model, or design pattern. | Use when it fits the business, data, and platform context. | Improves consistency and quality. | Avoid applying it mechanically without context. |
...
| Defect Management | A common data engineering method, operating model, or design pattern. | Use when it fits the business, data, and platform context. | Improves consistency and quality. | Avoid applying it mechanically without context. |
| Root Cause Analysis | A common data engineering method, operating model, or design pattern. | Use when it fits the business, data, and platform context. | Improves consistency and quality. | Avoid applying it mechanically without context. |
| Control Frameworks | A common data engineering method, operating model, or design pattern. | Use when it fits the business, data, and platform context. | Improves consistency and quality. | Avoid applying it mechanically without context. |

## 14. Tools and Technologies

| Tool / Technology | What It Does | Where It Fits | Beginner Note | Enterprise Consideration |
|---|---|---|---|---|
| dbt Tests | Supports work related to Data Quality. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| Great Expectations | Supports work related to Data Quality. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| Databricks Expectations | Supports work related to Data Quality. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| SQL Checks | Supports work related to Data Quality. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| Data Quality Dashboards | Supports work related to Data Quality. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| Unity Catalog | Supports work related to Data Quality. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| Microsoft Purview | Supports work related to Data Quality. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
| Monitoring Alerts | Supports work related to Data Quality. | Used for development, governance, monitoring, documentation, or consumption. | Learn the problem it solves before memorizing features. | Define ownership, access, naming, lifecycle, and operational support. |
...
It helps improve trusted reporting, automation reliability, reduced rework, better decision-making by making data more reliable, reusable, governed, and easier to consume.

### Technical Explanation

Data Quality supports the path from source systems through ingestion, transformation, validation, governance, and consumption.
...
> Data Quality helps us move from scattered, unreliable data work to a more governed and reusable data foundation. It supports reporting, automation, and AI by making data easier to trust, trace, secure, and operate.

## 17. Example Scenario

### Business Problem

Automations consume curated policy tables, but missing premium values and duplicate policy versions cause bot failures and incorrect downstream handling.
...
|---|---|---|---|---|---|---|
| Beginner | Basic purpose and vocabulary of Data Quality. | What it is and why it matters. | A one-page summary. | Memorizing terms without context. | Explain it to a non-technical person. | You can explain it simply. |
...
```text
02-data-engineering/data-quality/reference-guide.md
```
