---
title: "AI Fundamentals Reference Guide"
...
# AI Fundamentals Reference Guide

## 00. Executive Summary

AI Fundamentals covers the basic ideas behind artificial intelligence, machine learning, generative AI, and how these capabilities are applied responsibly in business.
...
AI Fundamentals matters because enterprise work must connect to business outcomes, not just technical activity.
...
- Simple explanation: AI Fundamentals covers the basic ideas behind artificial intelligence, machine learning, generative AI, and how these capabilities are applied responsibly in business.
...
A team needs to apply AI Fundamentals to a real initiative but lacks a common reference, ownership model, troubleshooting path, and governance checklist.
...
```text
ai-fundamentals/reference-guide.md
```
