---
title: "Applied AI Patterns Reference Guide"
...
# Applied AI Patterns Reference Guide

## 00. Executive Summary

Applied AI Patterns are reusable ways to apply AI to common work such as summarization, classification, extraction, drafting, analysis, search, and decision support.
...
Applied AI Patterns matters because enterprise work must connect to business outcomes, not just technical activity.
...
|---|---|---|---|
| Use Case | The specific business task AI is intended to support. | Keeps AI tied to value instead of novelty. | Summarize support tickets or classify documents. |
| Input Context | The information provided to the AI system. | Better context improves usefulness and reduces ambiguity. | Policy text, business rules, examples. |
| Grounding | Connecting AI output to trusted source material. | Improves factual reliability. | RAG over approved internal docs. |
| Evaluation | Testing whether output is accurate, safe, and useful. | Prevents unreliable AI from reaching production. | Human review rubric and test set. |
| Human Oversight | A person reviews, approves, or controls the final decision. | Reduces risk and preserves accountability. | Analyst approves generated recommendation. |
| Risk Control | A safeguard that reduces misuse, leakage, bias, or error. | Supports responsible AI. | Access control, logging, prompt injection testing. |
...
|---|---|
| NIST AI RMF | Add organization-specific guidance, examples, and links. |
| Responsible AI Principles | Add organization-specific guidance, examples, and links. |
| RAG Pattern | Add organization-specific guidance, examples, and links. |
| Human-in-the-Loop | Add organization-specific guidance, examples, and links. |
| Model Evaluation Rubric | Add organization-specific guidance, examples, and links. |
| AI Risk Register | Add organization-specific guidance, examples, and links. |
| Prompt Pattern Catalog | Add organization-specific guidance, examples, and links. |

## 14. Tools and Technologies

| Tool / Technology | Notes |
|---|---|
| ChatGPT / Claude / Copilot | Add organization-specific guidance, examples, and links. |
| Vector Databases | Add organization-specific guidance, examples, and links. |
| RAG Frameworks | Add organization-specific guidance, examples, and links. |
| Evaluation Rubrics | Add organization-specific guidance, examples, and links. |
| Prompt Libraries | Add organization-specific guidance, examples, and links. |
| Model Monitoring | Add organization-specific guidance, examples, and links. |
| AI Governance Registers | Add organization-specific guidance, examples, and links. |
| Python | Add organization-specific guidance, examples, and links. |
...
- Simple explanation: Applied AI Patterns are reusable ways to apply AI to common work such as summarization, classification, extraction, drafting, analysis, search, and decision support.
...
A team needs to apply Applied AI Patterns to a real initiative but lacks a common reference, ownership model, troubleshooting path, and governance checklist.
...
```text
applied-ai-patterns/reference-guide.md
```
