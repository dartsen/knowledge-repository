...
# Power BI Reference Guide

## 00. Executive Summary

Power BI is Microsoft’s business intelligence platform for creating semantic models, reports, dashboards, apps, and governed analytics experiences.
...
**Analogy:** Think of Power BI as the storefront for business data. The data platform prepares the ingredients, the semantic model organizes them, and Power BI presents the finished meal to decision-makers.

At a beginner level, focus on what Power BI is and how it helps people use data.

At a professional level, focus on how Power BI fits into the full analytics lifecycle: data source, model, calculation, report, security, deployment, adoption, monitoring, and continuous improvement.
...
|---|---|---|---|
| Semantic Model | A reusable model that organizes data for reporting and analysis. | Prevents every report from redefining business logic. | A certified sales or policy model used by many reports. |
| Report | A multi-page interactive analytical view built from a semantic model. | Helps users explore and understand data. | Monthly operations report. |
| Dashboard | A single-page monitoring view made of pinned tiles. | Gives quick visibility into key metrics. | Executive KPI dashboard. |
| Workspace | A collaborative container for Power BI content. | Supports ownership, permissions, and lifecycle management. | Finance Analytics workspace. |
| App | A packaged experience for distributing content to users. | Improves controlled sharing. | Operations Reporting app. |
| Gateway | A bridge between Power BI cloud and on-premises data sources. | Supports secure refresh of non-cloud data. | SQL Server gateway for scheduled refresh. |
| Deployment Pipeline | A lifecycle tool for moving content across development, test, and production. | Supports controlled release management. | Dev → Test → Prod Power BI deployment. |

## 04. Architecture View

Power BI fits within the broader analytics architecture from data source to business consumption.
...
A typical Power BI flow can be represented as:

```text
Data Sources → Power Query / Dataflows → Semantic Model → Reports → Dashboards / Apps → Users → Usage Monitoring → Improvement
```
...
|---|---|---|---|---|
| Star Schema | A common analytics, BI, modeling, or governance pattern. | Use when it fits the audience, data, and operating model. | Improves consistency, trust, and maintainability. | Avoid applying it mechanically without business context. |
| Semantic Model Governance | A common analytics, BI, modeling, or governance pattern. | Use when it fits the audience, data, and operating model. | Improves consistency, trust, and maintainability. | Avoid applying it mechanically without business context. |
| Self-Service BI | A common analytics, BI, modeling, or governance pattern. | Use when it fits the audience, data, and operating model. | Improves consistency, trust, and maintainability. | Avoid applying it mechanically without business context. |
| Managed Self-Service BI | A common analytics, BI, modeling, or governance pattern. | Use when it fits the audience, data, and operating model. | Improves consistency, trust, and maintainability. | Avoid applying it mechanically without business context. |
| Deployment Pipeline ALM | A common analytics, BI, modeling, or governance pattern. | Use when it fits the audience, data, and operating model. | Improves consistency, trust, and maintainability. | Avoid applying it mechanically without business context. |
| Certified Dataset Pattern | A common analytics, BI, modeling, or governance pattern. | Use when it fits the audience, data, and operating model. | Improves consistency, trust, and maintainability. | Avoid applying it mechanically without business context. |
| Report Usage Monitoring | A common analytics, BI, modeling, or governance pattern. | Use when it fits the audience, data, and operating model. | Improves consistency, trust, and maintainability. | Avoid applying it mechanically without business context. |

## 14. Tools and Technologies

| Tool / Technology | What It Does | Where It Fits | Beginner Note | Enterprise Consideration |
|---|---|---|---|---|
| Power BI Desktop | Supports analytics and BI work related to Power BI. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Power BI Service | Supports analytics and BI work related to Power BI. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Microsoft Fabric | Supports analytics and BI work related to Power BI. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Power Query | Supports analytics and BI work related to Power BI. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| DAX | Supports analytics and BI work related to Power BI. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Tabular Editor | Supports analytics and BI work related to Power BI. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| DAX Studio | Supports analytics and BI work related to Power BI. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Power BI Report Builder | Supports analytics and BI work related to Power BI. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Deployment Pipelines | Supports analytics and BI work related to Power BI. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
| Power BI REST APIs | Supports analytics and BI work related to Power BI. | Used for modeling, reporting, governance, delivery, or monitoring. | Learn what problem it solves before learning every feature. | Define ownership, permissions, lifecycle, endorsement, and support model. |
...
It helps improve self-service analytics, executive visibility, operational reporting, governed insights by turning trusted data into useful, governed, and actionable insights.

### Technical Explanation

Power BI sits between governed data sources and business users, usually through semantic models, reports, dashboards, apps, access controls, refresh schedules, and deployment processes.
...
> Power BI helps make analytics usable and trustworthy by connecting business questions to governed data, reusable models, clear visuals, controlled access, and a sustainable lifecycle.

## 17. Example Scenario

### Business Problem

A business team wants to replace spreadsheet-based reporting with governed Power BI reports built on reusable semantic models connected to trusted Databricks data.
...
|---|---|---|---|---|---|---|
| Beginner | Basic purpose and vocabulary of Power BI. | What it is and why it matters. | A one-page summary. | Focusing only on visuals. | Explain it to a business user. | You can explain it simply. |
...
```text
03-analytics-bi/power-bi/reference-guide.md
```
