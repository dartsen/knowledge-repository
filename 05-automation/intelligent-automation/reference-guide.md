---
title: "Intelligent Automation Reference Guide"
domain: "Automation"
...
# Intelligent Automation Reference Guide

## 00. Executive Summary

Intelligent Automation combines workflow automation, RPA, data, APIs, AI, and business rules to reduce manual effort and improve process reliability.
...
Intelligent Automation matters because enterprise work must connect to business outcomes, not just technical activity.
...
|---|---|---|---|
| Trigger | The event or schedule that starts an automation. | Defines when work begins. | Email received, queue item, daily schedule. |
| Business Rule | Logic that determines what action should happen. | Keeps automation aligned to process. | Only process policies with active status. |
| Exception | A condition the automation cannot handle normally. | Prevents silent failure. | Missing required document. |
| Retry | A controlled attempt to rerun a failed step. | Handles temporary issues. | Retry API call after timeout. |
| Queue | A worklist of items to process. | Supports scale and tracking. | UiPath queue items. |
| Monitoring | Tracking automation runs, failures, volume, and outcomes. | Supports operational control. | Dashboard of success and exception rate. |
...
|---|---|
| Power Automate | Add organization-specific guidance, examples, and links. |
| Power Platform Admin Center | Add organization-specific guidance, examples, and links. |
| UiPath Studio | Add organization-specific guidance, examples, and links. |
| UiPath Orchestrator | Add organization-specific guidance, examples, and links. |
| Databricks | Add organization-specific guidance, examples, and links. |
| Power BI | Add organization-specific guidance, examples, and links. |
| SharePoint | Add organization-specific guidance, examples, and links. |
| Azure DevOps | Add organization-specific guidance, examples, and links. |
...
- Simple explanation: Intelligent Automation combines workflow automation, RPA, data, APIs, AI, and business rules to reduce manual effort and improve process reliability.
...
A team needs to apply Intelligent Automation to a real initiative but lacks a common reference, ownership model, troubleshooting path, and governance checklist.
...
```text
intelligent-automation/reference-guide.md
```
