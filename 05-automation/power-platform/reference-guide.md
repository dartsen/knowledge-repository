---
title: "Power Platform Reference Guide"
domain: "Automation"
...
# Power Platform Reference Guide

## 00. Executive Summary

Power Platform is Microsoft’s low-code ecosystem for apps, workflows, data, copilots, and analytics, commonly used for business automation and rapid solution delivery.
...
Power Platform matters because enterprise work must connect to business outcomes, not just technical activity.
...
- Simple explanation: Power Platform is Microsoft’s low-code ecosystem for apps, workflows, data, copilots, and analytics, commonly used for business automation and rapid solution delivery.
...
A team needs to apply Power Platform to a real initiative but lacks a common reference, ownership model, troubleshooting path, and governance checklist.
...
```text
power-platform/reference-guide.md
```
