---
title: "Identity and Access Management Reference Guide"
...
# Identity and Access Management Reference Guide

## 00. Executive Summary

Identity and Access Management, or IAM, controls who or what can access systems, data, platforms, and services.
...
Identity and Access Management matters because enterprise work must connect to business outcomes, not just technical activity.
...
|---|---|---|---|
| Resource | A cloud asset such as compute, storage, identity, or network. | Defines what is managed. | Azure Storage Account. |
| Identity | A user, service principal, or managed identity. | Controls access. | Automation service principal. |
| Least Privilege | Granting only the access needed. | Reduces security risk. | Read-only access to curated table. |
| Container | A packaged runtime unit. | Improves portability. | Docker image for dbt project. |
| Monitoring | Logs, metrics, and alerts. | Supports reliability. | Alert when pipeline fails. |
| IaC | Defining infrastructure in code. | Improves repeatability. | Terraform or Bicep template. |
...
|---|---|
| Well-Architected Framework | Add organization-specific guidance, examples, and links. |
| Zero Trust | Add organization-specific guidance, examples, and links. |
| Infrastructure as Code | Add organization-specific guidance, examples, and links. |
| Least Privilege | Add organization-specific guidance, examples, and links. |
| Containerization | Add organization-specific guidance, examples, and links. |
| Observability | Add organization-specific guidance, examples, and links. |
| DevSecOps | Add organization-specific guidance, examples, and links. |

## 14. Tools and Technologies

| Tool / Technology | Notes |
|---|---|
| Azure Portal | Add organization-specific guidance, examples, and links. |
| Azure CLI | Add organization-specific guidance, examples, and links. |
| Docker | Add organization-specific guidance, examples, and links. |
| Azure Monitor | Add organization-specific guidance, examples, and links. |
| Key Vault | Add organization-specific guidance, examples, and links. |
| Managed Identities | Add organization-specific guidance, examples, and links. |
| Terraform / Bicep | Add organization-specific guidance, examples, and links. |
| Azure DevOps Pipelines | Add organization-specific guidance, examples, and links. |
...
- Simple explanation: Identity and Access Management, or IAM, controls who or what can access systems, data, platforms, and services.
...
A team needs to apply Identity and Access Management to a real initiative but lacks a common reference, ownership model, troubleshooting path, and governance checklist.
...
```text
identity-access-management/reference-guide.md
```
