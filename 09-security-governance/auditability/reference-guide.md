---
title: "Auditability Reference Guide"
...
# Auditability Reference Guide

## 00. Executive Summary

Auditability is the ability to prove what happened, who approved it, what changed, what controls exist, and how evidence can be reviewed.
...
Auditability matters because enterprise work must connect to business outcomes, not just technical activity.
...
|---|---|---|---|
| Owner | Person or team accountable for an asset or process. | Prevents confusion. | Data owner for policy attributes. |
| Control | A safeguard or requirement that reduces risk. | Supports compliance and reliability. | Access approval. |
| Policy | A rule or standard the organization follows. | Creates consistency. | Sensitive data handling policy. |
| Evidence | Proof that a control was followed. | Supports auditability. | Approval record or test result. |
| Exception | Approved deviation from a standard. | Makes risk explicit. | Temporary access exception. |
| Review Cadence | How often something is reviewed. | Keeps controls alive. | Quarterly access review. |
...
|---|---|
| Three Lines of Defense | Add organization-specific guidance, examples, and links. |
| Risk and Control Matrix | Add organization-specific guidance, examples, and links. |
| NIST AI RMF | Add organization-specific guidance, examples, and links. |
| Data Governance Operating Model | Add organization-specific guidance, examples, and links. |
| Access Review Process | Add organization-specific guidance, examples, and links. |
| Change Advisory Process | Add organization-specific guidance, examples, and links. |
| Control Evidence Model | Add organization-specific guidance, examples, and links. |

## 14. Tools and Technologies

| Tool / Technology | Notes |
|---|---|
| Microsoft Purview | Add organization-specific guidance, examples, and links. |
| Power Platform CoE | Add organization-specific guidance, examples, and links. |
| Audit Logs | Add organization-specific guidance, examples, and links. |
| Access Reviews | Add organization-specific guidance, examples, and links. |
| Risk Registers | Add organization-specific guidance, examples, and links. |
| Policy Libraries | Add organization-specific guidance, examples, and links. |
| Ticketing Systems | Add organization-specific guidance, examples, and links. |
| Dashboards | Add organization-specific guidance, examples, and links. |
...
- Simple explanation: Auditability is the ability to prove what happened, who approved it, what changed, what controls exist, and how evidence can be reviewed.
...
A team needs to apply Auditability to a real initiative but lacks a common reference, ownership model, troubleshooting path, and governance checklist.
...
```text
auditability/reference-guide.md
```
