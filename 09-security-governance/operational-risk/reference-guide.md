---
title: "Operational Risk Reference Guide"
...
# Operational Risk Reference Guide

## 00. Executive Summary

Operational Risk is the risk of loss, disruption, error, or failure caused by people, process, systems, data, or external events.
...
Operational Risk matters because enterprise work must connect to business outcomes, not just technical activity.
...
- Simple explanation: Operational Risk is the risk of loss, disruption, error, or failure caused by people, process, systems, data, or external events.
...
A team needs to apply Operational Risk to a real initiative but lacks a common reference, ownership model, troubleshooting path, and governance checklist.
...
```text
operational-risk/reference-guide.md
```
