---
title: "Service Principals Reference Guide"
...
# Service Principals Reference Guide

## 00. Executive Summary

Service Principals are non-human identities used by applications, automations, and pipelines to access resources securely.
...
Service Principals matters because enterprise work must connect to business outcomes, not just technical activity.
...
- Simple explanation: Service Principals are non-human identities used by applications, automations, and pipelines to access resources securely.
...
A team needs to apply Service Principals to a real initiative but lacks a common reference, ownership model, troubleshooting path, and governance checklist.
...
```text
service-principals/reference-guide.md
```
