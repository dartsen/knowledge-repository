---
title: "AI Governance Reference Guide"
...
# AI Governance Reference Guide

## 00. Executive Summary

AI Governance defines the policies, controls, roles, approval gates, monitoring, and accountability needed to manage AI use responsibly.
...
AI Governance matters because enterprise work must connect to business outcomes, not just technical activity.
...
- Simple explanation: AI Governance defines the policies, controls, roles, approval gates, monitoring, and accountability needed to manage AI use responsibly.
...
A team needs to apply AI Governance to a real initiative but lacks a common reference, ownership model, troubleshooting path, and governance checklist.
...
```text
ai-governance/reference-guide.md
```
